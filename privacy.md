...
meta:
  - name: og:title
    content: openHAB - Privacy Policy
  - name: og:description
...
-->
<p style="display: flex; align-items: center; gap: 0.5rem; margin: 0.25rem 0;">
  ...
  <a href="tel:+4961546039765">+49 (6154) 603-9765</a>
</p>
<p style="display: flex; align-items: center; gap: 0.5rem; margin: 0.25rem 0;">
  <svg style="width:16px;height:16px;flex-shrink:0" viewBox="0 0 24 24">
    <path fill="currentColor" d="M4,4H20A2,2 0 0,1 22,6V18A2,2 0 0,1 20,20H4C2.89,20 2,19.1 2,18V6C2,4.89 2.89,4 4,4M12,11L20,6H4L12,11M4,18H20V8.37L12,13.36L4,8.37V18Z" />
  </svg>
  <a href="mailto:info@openhabfoundation.org">info@openhabfoundation.org</a>
</p>
