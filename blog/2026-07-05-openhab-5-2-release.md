...
tags:
  - news
excerpt: >--
  Can you belive it's already been a year since the major release of openHAB 5.0? We are thrilled to introduce openHAB 5.2, packed with exciting new features, plenty of bug fixes and amazing new AI features!
---

Can you belive it's already been a year since the major release of openHAB 5.0?
...
But that's not all!
Following the release of [openHAB 5.1](/blob/2025-12-22-openhab-5-1-release.html) last winter with many "under the hood" changes, this release focuses on more visual changes.
...
Activity across our GitHub repositories has been non-stop over this past few months.
Altogether, TODO contributors poured their efforts into a whopping TODO commits across our [GitHub repositories](https://github.com/openhab).

This big release includes impactful work across every part of the ecosystem:

- **[Core](https://github.com/openhab/openhab-core)**: TODO
- **[Add-ons](https://github.com/openhab/openhab-addons)**: TODO
- **[UIs](https://github.com/openhab/openhab-webui)**: TODO
...
Beyond coding, many of these individuals pull double duty as maintainers — evaluating pull requests, shaping architectural decicions, and mentoring newcomers.
